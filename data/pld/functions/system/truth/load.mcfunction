scoreboard objectives add trigger_shen_hide trigger ["神族真相任务对话触发器"]
scoreboard objectives add trigger_yao_hide trigger ["妖族真相任务对话触发器"]
scoreboard objectives add trigger_xian_hide trigger ["仙族真相任务对话触发器"]
scoreboard objectives add trigger_zhan_hide trigger ["战神族真相任务对话触发器"]
scoreboard objectives add trigger_ren_hide trigger ["人族真相任务对话触发器"]

scoreboard objectives add trigger_shen_hide_item trigger ["神族真相任务物品触发器"]
scoreboard objectives add trigger_yao_hide_item trigger ["妖族真相任务物品触发器"]
scoreboard objectives add trigger_xian_hide_item trigger ["仙族真相任务物品触发器"]
scoreboard objectives add trigger_zhan_hide_item trigger ["战神族真相任务物品触发器"]
scoreboard objectives add trigger_ren_hide_item trigger ["人族真相任务物品触发器"]
