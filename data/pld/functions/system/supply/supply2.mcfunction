...
execute store success score @s[scores={supply5ticks=-1}] success unless score #system supply_add_xian matches 1 run give @s minecraft:brick{CustomModelData:3,id:"panling:money2",display:{Name:'{"translate":"pl.item.name.money2"}',Lore:['{"translate":"pl.item.lore.money2a"}','{"translate":"pl.item.lore.money2b"}','{"translate":"pl.item.lore.money2c"}']}}
execute store success score @s[scores={supply5ticks=-1}] success if score #system supply_add_xian matches 1 run give @s minecraft:brick{CustomModelData:3,id:"panling:money2",display:{Name:'{"translate":"pl.item.name.money2"}',Lore:['{"translate":"pl.item.lore.money2a"}','{"translate":"pl.item.lore.money2b"}','{"translate":"pl.item.lore.money2c"}']}} 2
