...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{tag:{instance:1,chest:3}}}]
loot spawn ~ ~ ~ loot pld:chests/goldchests/instance1
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{tag:{instance:1,chest:3}}}] run function pld:system/chests/goldchests/instance1/judge
