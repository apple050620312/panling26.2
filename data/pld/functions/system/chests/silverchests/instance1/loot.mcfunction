...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{tag:{instance:1,chest:2}}}]
loot spawn ~ ~ ~ loot pld:chests/silverchests/instance1
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{tag:{instance:1,chest:2}}}] run function pld:system/chests/silverchests/instance1/judge
