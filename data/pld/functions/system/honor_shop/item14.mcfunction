...
give @s[tag=buy_success] minecraft:leather_helmet{id:"panling:flower_helmet",Unbreakable:1b,display:{Name:'[{"translate":"pl.item.name.flower_helmet"}]',Lore:['{"translate":"pl.item.lore.honor_heads"}','{"translate":"pl.item.lore.flower_helmeta"}','{"translate":"pl.item.lore.flower_helmetb"}','{"translate":""}','{"translate":"pl.item.lore.flower_helmetc"}','{"translate":"pl.item.lore.flower_helmetd"}']}}
