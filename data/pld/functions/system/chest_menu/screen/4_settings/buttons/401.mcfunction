...
item replace entity @s enderchest.2 with iron_chestplate{clickable:1,to_screen:401,HideFlags:63,display:{Name:'{"translate":"pl.chest_menu.switch_info.armor_skill.name"}'}}
