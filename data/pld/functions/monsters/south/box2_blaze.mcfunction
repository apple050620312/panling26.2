...
execute if score @s monster_count matches ..9 run summon minecraft:blaze ~ ~ ~ {Team:"monster",Tags:["panling","not_undead","monster","south_blaze"],Health:35.0f,CustomNameVisible:1b,CustomName:'{"translate":"pl.monster.south.box2_blaze"}',DeathLootTable:"pld:south/entity/box2_blaze",Attributes:[{Name:"generic.max_health",Base:35d},{Name:"generic.follow_range",Base:20d},{Name:"generic.movement_speed",Base:0.2d},{Name:"generic.attack_damage",Base:0d}]}
kill @s 