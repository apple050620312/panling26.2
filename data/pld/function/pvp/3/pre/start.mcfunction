...
summon minecraft:skeleton 2369 113 -1801 {Tags:["panling","pvp3"],PersistenceRequired:1b,CanPickUpLoot:false,ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f],CustomNameVisible:1b,CustomName:'{"translate":"pl.npc.name.pvp3_guard"}',DeathLootTable:"pld:empty",Health:50.0f,Attributes:[{Name:"max_health",Base:50d},{Name:"movement_speed",Base:0d},{Name:"attack_damage",Base:10d},{Name:"follow_range",Base:40d},{Name:"knockback_resistance",Base:1d}],ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b,components:{"minecraft:unbreakable":{}}},{id:"minecraft:chainmail_leggings",Count:1b,components:{"minecraft:unbreakable":{}}},{id:"minecraft:chainmail_chestplate",Count:1b,components:{"minecraft:unbreakable":{}}},{id:"minecraft:player_head",Count:1b,components:{"minecraft:custom_data":{SkullOwner:{Id:[I;260497508,-338736586,-1333673891,-1422241753],Properties:{textures:[{Value: ""}]}}}}}],HandItems:[{id:"bow",Count:1b,components:{"minecraft:unbreakable":{},"minecraft:enchantments":{levels:{"power":13,"punch":5}}}},{}]}
...
execute as @a[team=attack] run attribute @s attack_damage modifier remove 101-0-0-0-0
execute as @a[team=defence] run attribute @s attack_damage modifier remove 101-0-0-0-0