...
#硫磺炸药激活
execute as @e[type=item,nbt={Item:{components:{custom_data:{id:"panling:pvp1_tnt"}}}}] unless entity @e[type=tnt] at @s if block ~ ~-1 ~ birch_planks positioned ~ ~1 ~ unless score #system pvp1_tnt_cool matches 0.. run function pld:pvp/1/ing/atk/tnt
