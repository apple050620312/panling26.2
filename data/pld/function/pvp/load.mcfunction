...
#双方玩家数量
scoreboard objectives add pvp_atk_count dummy ["玩家进攻方队伍标记"]
scoreboard objectives add pvp_def_count dummy ["玩家防守方队伍标记"]
...
scoreboard objectives add pvp_team dummy ["玩家参与队伍标记"]
...
#标记-玩家在属性购买区域内
scoreboard objectives add inbuy_area dummy ["标记-玩家在属性购买区域内"]
#玩家重生时间倒数
...
scoreboard objectives add pvp3_trans_tower dummy ["pvp3镇妖塔反转标记"]
scoreboard objectives add pvp3_trans_tick dummy ["pvp3镇妖塔反转时间"]

scoreboard objectives add pvp3_trans_cd dummy ["pvp3镇妖塔反转总时间"]
