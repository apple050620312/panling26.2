...
execute as @a[nbt={Inventory:[{components:{custom_data:{id:"panling:pvp2_sp_item1"}}}]}] run function pld:pvp/2/ing/sp_item/use/1
execute as @a[nbt={Inventory:[{components:{custom_data:{id:"panling:pvp2_sp_item2"}}}]}] run function pld:pvp/2/ing/sp_item/use/2
execute as @a[nbt={Inventory:[{components:{custom_data:{id:"panling:pvp2_sp_item3"}}}]}] run function pld:pvp/2/ing/sp_item/use/3
