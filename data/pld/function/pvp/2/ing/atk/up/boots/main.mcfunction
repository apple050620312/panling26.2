...
#更新物品
clear @s leather_boots[custom_data={id:"panling:pvp2_atk_boots"}]
item replace entity @s armor.feet with leather_boots[custom_name='[{"translate":"pl.pvp2.item.name.atk_boots"},{"text":"+","color":"aqua","italic":false}]',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','[{"translate":"pl.attribute.knockback_resistance"},{"text":"50%","color":"white","italic":false}]','{"translate":""}','{"translate":"pl.pvp.item.uped"}'],unbreakable={},minecraft:enchantments={"minecraft:binding_curse":1},custom_data={id:"panling:pvp2_atk_boots",pvp:1,AttributeModifiers:[{Slot:"feet",UUID:[I;4,4,4,4],Operation:0,AttributeName:"minecraft:armor",Amount:2},{Slot:"feet",UUID:[I;4,4,4,4],Operation:0,AttributeName:"minecraft:knockback_resistance",Amount:0.5}]}]
