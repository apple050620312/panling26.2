...
#给玩家放置物品
item replace entity @s armor.head with leather_helmet[custom_name='{"translate":"pl.pvp2.item.name.atk_helmet"}',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','{"translate":""}','{"translate":"pl.pvp.item.can_up"}'],unbreakable={},minecraft:enchantments={minecraft:binding_curse:1},custom_data={id:"panling:pvp2_atk_helmet",pvp:1,AttributeModifiers:[{Slot:"head",UUID:[I;1,1,1,1],Operation:0,AttributeName:"minecraft:armor",Amount:2}]}]
item replace entity @s armor.chest with leather_chestplate[custom_name='{"translate":"pl.pvp2.item.name.atk_chestplate"}',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','{"translate":"pl.pvp.item.lore.arrow_protection"}','{"translate":""}','{"translate":"pl.pvp.item.can_up"}'],unbreakable={},minecraft:enchantments={minecraft:binding_curse:1,minecraft:projectile_protection:1},custom_data={id:"panling:pvp2_atk_chestplate",pvp:1,AttributeModifiers:[{Slot:"chest",UUID:[I;2,2,2,2],Operation:0,AttributeName:"minecraft:armor",Amount:2}]}]
item replace entity @s armor.legs with leather_leggings[custom_name='{"translate":"pl.pvp2.item.name.atk_leggings"}',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','{"translate":"pl.pvp.item.lore.arrow_protection"}','{"translate":""}','{"translate":"pl.pvp.item.can_up"}'],unbreakable={},minecraft:enchantments={minecraft:binding_curse:1,minecraft:projectile_protection:1},custom_data={id:"panling:pvp2_atk_leggings",pvp:1,AttributeModifiers:[{Slot:"legs",UUID:[I;3,3,3,3],Operation:0,AttributeName:"minecraft:armor",Amount:2}]}]
item replace entity @s armor.feet with leather_boots[custom_name='{"translate":"pl.pvp2.item.name.atk_boots"}',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','{"translate":""}','{"translate":"pl.pvp.item.can_up"}'],unbreakable={},minecraft:enchantments={minecraft:binding_curse:1},custom_data={id:"panling:pvp2_atk_boots",pvp:1,AttributeModifiers:[{Slot:"feet",UUID:[I;4,4,4,4],Operation:0,AttributeName:"minecraft:armor",Amount:2}]}]
...
item replace entity @s hotbar.1 with bow[custom_name='{"translate":"pl.pvp2.item.name.atk_bow"}',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":"pl.pvp2.item.lore.atk_bow"}','{"translate":""}','[{"translate":"pl.attribute.bow_power"},{"text":"1","color":"white","italic":false}]','{"translate":"pl.lore.flame"}','{"translate":""}','{"translate":"pl.pvp.item.can_up"}'],unbreakable={},minecraft:enchantments={minecraft:flame:1,minecraft:infinity:1},custom_data={id:"panling:pvp2_atk_bow",pvp:1}]
item replace entity @s hotbar.2 with arrow[custom_name='{"translate":"pl.pvp2.item.name.atk_arrow"}',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":"pl.pvp2.item.lore.atk_arrow"}'],minecraft:enchantments={minecraft:protection:1},custom_data={id:"panling:pvp2_atk_arrow",pvp:1}]
