...
#更新物品
clear @s leather_helmet[custom_data={id:"panling:pvp2_def_helmet"}]
item replace entity @s armor.head with leather_helmet[custom_name='[{"translate":"pl.pvp2.item.name.def_helmet"},{"text":"+","color":"aqua","italic":false}]',lore=['{"translate":"pl.pvp.item.limit"}','{"translate":""}','[{"translate":"pl.attribute.armor"},{"text":"2","color":"white","italic":false}]','{"translate":"pl.pvp.item.lore.arrow_protection"}','{"translate":""}','{"translate":"pl.pvp.item.uped"}'],unbreakable={},hide_additional_tooltip={},enchantments={levels:{"minecraft:binding_curse":1,"minecraft:projectile_protection":1}},custom_data={id:"panling:pvp2_def_helmet",pvp:1,AttributeModifiers:[{Slot:"head",UUID:[I;1,1,1,1],Operation:0,AttributeName:"minecraft:generic.armor",Amount:2}]}]
