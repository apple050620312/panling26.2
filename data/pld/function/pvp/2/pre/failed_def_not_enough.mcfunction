...
tellraw @a {"translate":"pl.info.pvp2_notice_def_not_enough1"}
tellraw @a {"translate":"pl.info.pvp2_notice_def_not_enough2"}
tellraw @a {"translate":"pl.info.pvp2_notice_def_not_enough3"}
