...
#如果检查到掉落物品 就把对应位置染色
execute positioned 2834.5 31 -858.5 if entity @e[distance=..4.5,type=item,nbt={Item:{components:{custom_data:{instance:30}}}}] run function pld:instances/instance3_0/floors/-4/skill/explode/eye/0/0
execute positioned 2834.5 31 -858.5 if entity @e[distance=..4.5,type=item,nbt={Item:{components:{custom_data:{instance:31}}}}] run function pld:instances/instance3_0/floors/-4/skill/explode/eye/0/1
execute positioned 2834.5 31 -838.5 if entity @e[distance=..4.5,type=item,nbt={Item:{components:{custom_data:{instance:30}}}}] run function pld:instances/instance3_0/floors/-4/skill/explode/eye/1/0
