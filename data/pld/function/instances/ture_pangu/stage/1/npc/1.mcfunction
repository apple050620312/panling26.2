#喊话
#生成npc
#/summon Villager -292 155 -1520 {Profession:1,CustomName:♥♥♥♥♥♥♥♥♥♥,CustomNameVisible:1,Offers:{Recipes:[{uses:-2000000000,rewardExp:0b,buy:{id:"minecraft:dye",Damage:10s,count:99,components:{display:{Name:"死士-五行金陣陣眼：",Lore:["§7§o快，掩護我前往陣法設置處！"]}}},sell:{id:"minecraft:dye",Damage:10s,count:99,components:{display:{Name:"死士-五行金陣陣眼：",Lore:["§7§o我身上的陣法不能承受太多攻擊。","§7§o拜託了，請將敵人阻攔在五步之外！"]}}}}]},Attributes:[{Name:generic.movementSpeed,Base:0.0},{Name:generic.maxHealth,Base:30000}],PersistenceRequired:1,Invulnerable:1,Silent:1,NoAI:1,Career:1,CareerLevel:26}
