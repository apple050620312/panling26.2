scoreboard objectives add instance3_5f dummy ["鎮妖塔是否通过第五层"]
#玩家身上是前几层的倒计时、system上是boss战的阶段倒计时
scoreboard objectives add instance3_tick dummy ["鎮妖塔计时"]
scoreboard objectives add instance3_floor dummy ["鎮妖塔玩家所在层"]
scoreboard objectives add instance3_debuff dummy ["鎮妖塔妖族玩家负面等级"]

scoreboard objectives add instance3_skill dummy ["鎮妖塔大长老施法标记"]
scoreboard objectives add instance3_bosshp dummy ["鎮妖塔大长老血量"]

scoreboard objectives add instance3_kill teamkill.dark_red ["鎮妖塔怪物击杀检测"]
scoreboard objectives add instance3_tickxs dummy ["鎮妖塔倒计时显示"]
