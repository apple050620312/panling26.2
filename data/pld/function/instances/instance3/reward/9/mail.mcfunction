...
loot replace block 0 -1 0 container.1 loot pld:items/armor_core_4
data modify block 0 -1 0 Items[1].count set value 2b
loot replace block 0 -1 0 container.2 loot pld:items/yy2
data modify block 0 -1 0 Items[2].count set value 2b
loot replace block 0 -1 0 container.3 loot pld:items/metal
data modify block 0 -1 0 Items[3].count set value 20b
loot replace block 0 -1 0 container.4 loot pld:items/wood
data modify block 0 -1 0 Items[4].count set value 20b
...
loot replace block 0 -1 0 container.0 loot pld:items/water
data modify block 0 -1 0 Items[0].count set value 20b
loot replace block 0 -1 0 container.1 loot pld:items/fire
data modify block 0 -1 0 Items[1].count set value 20b
loot replace block 0 -1 0 container.2 loot pld:items/earth
...
data modify storage pld:system Temp_player_new_mails[1].attached_items append from block 0 -1 0 Items[2]
