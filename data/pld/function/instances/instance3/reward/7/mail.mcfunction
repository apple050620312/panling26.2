...
data modify block 0 -1 0 Items[0].count set value 15b
loot replace block 0 -1 0 container.1 loot pld:items/earth
data modify block 0 -1 0 Items[1].count set value 15b
