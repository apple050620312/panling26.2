...
loot replace block 0 -1 0 container.0 loot pld:items/weapon_core_3
loot replace block 0 -1 0 container.1 loot pld:items/armor_core_3
data modify block 0 -1 0 Items[1].Count set value 2b
loot replace block 0 -1 0 container.2 loot pld:items/yy1
