...
scoreboard objectives add instance1_failed dummy ["始皇陵阶段失败数量"]
scoreboard objectives add instance1_fail1 dummy ["始皇陵1失败标记"]
scoreboard objectives add instance1_fail2 dummy ["始皇陵2失败标记"]
