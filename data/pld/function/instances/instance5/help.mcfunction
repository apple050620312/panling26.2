...
execute if score #system instance5_helptk matches 283 run summon armor_stand 3157 166 -1840 {Tags:["zhanglao"],CustomName:"",CustomNameVisible:0,Invulnerable:1,DisabledSlots:2039552,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1},{id:"minecraft:chainmail_leggings",Count:1},{id:"minecraft:chainmail_chestplate",Count:1},{id:"minecraft:player_head",Count:1,tag:{SkullOwner:{Id:[I;260497508,-338736586,-1333673891,-1422241753],Properties:{textures:[{Value:""}]}}}}],Invisible:0,NoBasePlate:1,NoGravity:1,ShowArms:1,Small:0,Pose:{Body:[0.0F,0.0F,0.0F],LeftArm:[20F,0.0F,30F],RightArm:[20F,0.0F,330F],LeftLeg:[0.0F,0.0F,0.0F],RightLeg:[0.0F,0.0F,0.0F],Head:[0.0F,0.0F,0.0F]},Rotation:[90F,0.0F]}
...
execute if score #system instance5_helptk matches 143 run summon armor_stand 3157 166 -1840 {Tags:["zhanglao"],CustomName:"",CustomNameVisible:0,Invulnerable:1,DisabledSlots:2039552,Invisible:0,ArmorItems:[{id:"minecraft:chainmail_boots",Count:1},{id:"minecraft:chainmail_leggings",Count:1},{id:"minecraft:chainmail_chestplate",Count:1},{id:"minecraft:player_head",Count:1,tag:{SkullOwner:{Id:[I;260497508,-338736586,-1333673891,-1422241753],Properties:{textures:[{Value:""}]}}}}],NoBasePlate:1,NoGravity:1,ShowArms:1,Small:0,Pose:{Body:[0.0F,0.0F,0.0F],LeftArm:[20F,0.0F,30F],RightArm:[20F,0.0F,330F],LeftLeg:[0.0F,0.0F,0.0F],RightLeg:[0.0F,0.0F,0.0F],Head:[0.0F,0.0F,0.0F]},Rotation:[-90F,0.0F]}
