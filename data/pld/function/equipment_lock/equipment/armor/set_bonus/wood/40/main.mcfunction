#近战伤害和抗击退增幅
attribute @s attack_damage modifier add panling:mod_12_1_4_0_0 0.2 add_multiplied_base
attribute @s knockback_resistance modifier add panling:mod_12_1_4_0_0 0.2 add_multiplied_base
