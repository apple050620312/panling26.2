#近战伤害和抗击退增幅
attribute @s generic.attack_damage modifier add 12-1-4-0-0 "木四件套-战士近战伤害" 0.2 multiply_base
attribute @s generic.knockback_resistance modifier add 12-1-4-0-0 "木四件套-战士抗击退" 0.2 multiply_base
