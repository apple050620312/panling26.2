...
execute if entity @s[scores={armor_set_bonus_0_4_tick=0,job=0}] run attribute @s movement_speed modifier remove panling:mod_12_0_4_0_0
...
execute if entity @s[scores={armor_set_bonus_1_4_tick=0,job=1}] run attribute @s movement_speed modifier remove panling:mod_12_1_4_0_0
...
execute if entity @s[scores={armor_set_bonus_2_4_tick=0,job=0}] run attribute @s max_health modifier remove panling:mod_12_2_4_0_0 
execute if entity @s[scores={armor_set_bonus_2_4_tick=0,job=1}] run attribute @s movement_speed modifier remove panling:mod_12_2_4_0_0 
...
execute if entity @s[scores={armor_set_bonus_2_4_tick=0,job=1}] run attribute @s movement_speed modifier remove panling:mod_12_3_4_0_0


#土四件套-战
execute if score @s job matches 0 if entity @s[tag=earth_set_4a] unless score @s armor_set_bonus_cool_4_tick matches 1.. if predicate pld:effect_check/absorption run attribute @s attack_damage modifier add panling:mod_12_4_4_0_0 0.35 add_multiplied_base
execute unless entity @s[tag=earth_set_4a] if entity @s[scores={job=0}] run attribute @s attack_damage modifier remove panling:mod_12_4_4_0_0
...
#金四件套-圣兽
execute if entity @s[tag=metal_set_4b,scores={job=0,tiger=1}] run attribute @s attack_damage modifier add panling:mod_12_0_4_1_0 0.15 add_multiplied_base
execute unless entity @s[tag=metal_set_4b] if entity @s[scores={job=0,tiger=1}] run attribute @s attack_damage modifier remove panling:mod_12_0_4_1_0

#火四件套-圣兽
execute if entity @s[tag=fire_set_4b,scores={job=0,bird=1}] run attribute @s attack_damage modifier add panling:mod_12_3_4_1_0 0.15 add_multiplied_base
execute unless entity @s[tag=fire_set_4b] if entity @s[scores={job=0,bird=1}] run attribute @s attack_damage modifier remove panling:mod_12_3_4_1_0

#木四件套-圣兽
execute if entity @s[tag=wood_set_4b,scores={dragon=1}] run attribute @s max_health modifier add panling:mod_12_1_4_1_0 0.2 add_multiplied_base
execute unless entity @s[tag=wood_set_4b,scores={dragon=1}] run attribute @s max_health modifier remove panling:mod_12_1_4_1_0

#水四件套-圣兽
execute if entity @s[tag=water_set_4b,scores={turtle=1}] run attribute @s max_health modifier add panling:mod_12_2_4_1_0 0.2 add_multiplied_base
execute unless entity @s[tag=water_set_4b,scores={turtle=1}] run attribute @s max_health modifier remove panling:mod_12_2_4_1_0
