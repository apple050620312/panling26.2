...
#特殊加工
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{act:1,modify:1}}}]} run data modify block ~ 255 ~ Items[{components:{"minecraft:custom_data":{act:1,modify:1}}}].tag.AttributeModifiers set value [{Slot:"mainhand",UUID:[I;1,2,3,4],Operation:0,AttributeName:"minecraft:armor",Amount:0}]
...
execute as @s[nbt={Inventory:[{Slot:102b,components:{"minecraft:custom_data":{limit:3}}}]}] run function #pld:armor_unlock/3/chest
