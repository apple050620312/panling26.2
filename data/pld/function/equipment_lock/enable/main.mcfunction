...
execute if block ~ 255 ~ chest{Items:[{id:"minecraft:crossbow"}]} unless data block ~ 255 ~ {Items:[{components:{"minecraft:custom_data":{id:"panling:crossbow5"}}}]} run data modify block ~ 255 ~ Items[0].components."minecraft:enchantments"."minecraft:multishot" set value 1
...
#附灵属性激活
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{type:1}}}]} run function #pld:weapon_unlock/enchant
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{type:2}}}]} run function #pld:armor_unlock/enchant
...
#强化属性激活
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{type:1}}}]} run scoreboard players reset @s weapon_piercing_lvl
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{type:1}}}]} run scoreboard players reset @s weapon_arrow_crit
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{type:1}}}]} if data block ~ 255 ~ Items[0].components."minecraft:custom_data".enhance_lvl run function pld:equipment_lock/enable/enhance/check

#神器词条激活
execute if block ~ 255 ~ chest{Items:[{components:{"minecraft:custom_data":{type:2}}}]} if data block ~ 255 ~ Items[0].tag.legend_id run function pld:equipment_lock/enable/legend_id/check
