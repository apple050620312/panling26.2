...
execute unless score @s WeaponSlot matches -1 if data storage pld:system Temp[{Slot:0b,components:{"minecraft:custom_data":{act:1}}}] run data modify storage pld:system Temp[{components:{"minecraft:custom_data":{act:1}}}].tag.modify set value 1
