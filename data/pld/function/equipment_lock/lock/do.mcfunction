...
#execute if block ~ 255 ~ chest{Items:[{id:"minecraft:bow",components:{custom_data:{act:1,modify:1}}}]} run data modify block ~ 255 ~ Items[{id:"minecraft:bow",components:{custom_data:{act:1,modify:1}}}].id set value "minecraft:wooden_pickaxe"
#execute if block ~ 255 ~ chest{Items:[{id:"minecraft:crossbow",components:{custom_data:{act:1,modify:1}}}]} run data modify block ~ 255 ~ Items[{id:"minecraft:crossbow",components:{custom_data:{act:1,modify:1}}}].tag.CustomModelData set value 2
#execute if block ~ 255 ~ chest{Items:[{id:"minecraft:crossbow",components:{custom_data:{act:1,modify:1}}}]} run data modify block ~ 255 ~ Items[{id:"minecraft:crossbow",components:{custom_data:{act:1,modify:1}}}].id set value "minecraft:wooden_pickaxe"
# #act标签
#execute if block ~ 255 ~ chest{Items:[{components:{custom_data:{act:1,modify:1}}}]} run data modify block ~ 255 ~ Items[{components:{custom_data:{act:1,modify:1}}}].tag.act set value 0
#execute if block ~ 255 ~ chest{Items:[{components:{custom_data:{modify:1}}}]} run data modify block ~ 255 ~ Items[{components:{custom_data:{modify:1}}}].tag.modify set value 0
