...
#生成告示牌
execute if score #temp temp matches 1 run setblock ~ ~1 ~ minecraft:oak_sign[custom_data={front_text:{messages:['[{"selector":"@e[tag=panling,tag=enhance,tag=name1]"},{"text":" "},{"translate":"pl.lore.enhance.lvl1"}]','{"translate":""}','{"translate":""}','{"translate":""}']}}] replace
execute if score #temp temp matches 2 run setblock ~ ~1 ~ minecraft:oak_sign[custom_data={front_text:{messages:['[{"selector":"@e[tag=panling,tag=enhance,tag=name1]"},{"text":" "},{"translate":"pl.lore.enhance.lvl2"}]','{"translate":""}','{"translate":""}','{"translate":""}']}}] replace
execute if score #temp temp matches 3 run setblock ~ ~1 ~ minecraft:oak_sign[custom_data={front_text:{messages:['[{"selector":"@e[tag=panling,tag=enhance,tag=name1]"},{"text":" "},{"translate":"pl.lore.enhance.lvl3"}]','{"translate":""}','{"translate":""}','{"translate":""}']}}] replace
execute if score #temp temp matches 4 run setblock ~ ~1 ~ minecraft:oak_sign[custom_data={front_text:{messages:['[{"selector":"@e[tag=panling,tag=enhance,tag=name1]"},{"text":" "},{"translate":"pl.lore.enhance.lvl4"}]','{"translate":""}','{"translate":""}','{"translate":""}']}}] replace
