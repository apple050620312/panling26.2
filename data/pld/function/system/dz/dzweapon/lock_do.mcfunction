...
execute if data block ~ ~ ~ {Items:[{components:{"minecraft:custom_data":{act:1}}}]} run data modify block ~ ~ ~ Items[{components:{"minecraft:custom_data":{act:1}}}].tag.AttributeModifiers set value [{Slot:"mainhand",UUID:[I;5,5,5,6],Operation:0,AttributeName:"minecraft:attack_damage",Amount:0},{Slot:"mainhand",UUID:[I;1,1,1,9],Operation:0,AttributeName:"minecraft:armor",Amount:0}]
