...
#execute if block ~ ~ ~ minecraft:dispenser{Items:[{Slot:6b,id:"minecraft:glowstone_dust",Count:1b,components:{custom_data:{id:"panling:material_helmet"}}}]} run function pld:system/dz/dzslot/dzhelmet
#execute if block ~ ~ ~ minecraft:dispenser{Items:[{Slot:6b,id:"minecraft:glowstone_dust",Count:1b,components:{custom_data:{id:"panling:material_chestplate"}}}]} run function pld:system/dz/dzslot/dzchestplate
#execute if block ~ ~ ~ minecraft:dispenser{Items:[{Slot:6b,id:"minecraft:glowstone_dust",Count:1b,components:{custom_data:{id:"panling:material_leggings"}}}]} run function pld:system/dz/dzslot/dzleggings
#execute if block ~ ~ ~ minecraft:dispenser{Items:[{Slot:6b,id:"minecraft:glowstone_dust",Count:1b,components:{custom_data:{id:"panling:material_boots"}}}]} run function pld:system/dz/dzslot/dzboots
