...
execute store success score @s[scores={supply5ticks=-1}] success unless score #system supply_add_shen matches 1 run give @s minecraft:brick[custom_model_data=1,custom_name='{"translate":"pl.item.name.money0"}',lore=['{"translate":"pl.item.lore.money0a"}','{"translate":"pl.item.lore.money0b"}','{"translate":"pl.item.lore.money0c"}'],custom_data={id:"panling:money0"}]
execute store success score @s[scores={supply5ticks=-1}] success if score #system supply_add_shen matches 1 run give @s minecraft:brick[custom_model_data=1,custom_name='{"translate":"pl.item.name.money0"}',lore=['{"translate":"pl.item.lore.money0a"}','{"translate":"pl.item.lore.money0b"}','{"translate":"pl.item.lore.money0c"}'],custom_data={id:"panling:money0"}] 2
