...
execute store success score @s[scores={supply5ticks=-1}] success unless score #system supply_add_yao matches 1 run give @s minecraft:brick[minecraft:custom_model_data={floats:[2]},custom_name='{"translate":"pl.item.name.money1"}',lore=['{"translate":"pl.item.lore.money1a"}','{"translate":"pl.item.lore.money1b"}','{"translate":"pl.item.lore.money1c"}'],custom_data={id:"panling:money1"}]
execute store success score @s[scores={supply5ticks=-1}] success if score #system supply_add_yao matches 1 run give @s minecraft:brick[minecraft:custom_model_data={floats:[2]},custom_name='{"translate":"pl.item.name.money1"}',lore=['{"translate":"pl.item.lore.money1a"}','{"translate":"pl.item.lore.money1b"}','{"translate":"pl.item.lore.money1c"}'],custom_data={id:"panling:money1"}] 2
