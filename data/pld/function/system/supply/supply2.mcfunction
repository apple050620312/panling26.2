...
execute store success score @s[scores={supply5ticks=-1}] success unless score #system supply_add_xian matches 1 run give @s minecraft:brick[custom_model_data=3,custom_name='{"translate":"pl.item.name.money2"}',lore=['{"translate":"pl.item.lore.money2a"}','{"translate":"pl.item.lore.money2b"}','{"translate":"pl.item.lore.money2c"}'],custom_data={id:"panling:money2"}]
execute store success score @s[scores={supply5ticks=-1}] success if score #system supply_add_xian matches 1 run give @s minecraft:brick[custom_model_data=3,custom_name='{"translate":"pl.item.name.money2"}',lore=['{"translate":"pl.item.lore.money2a"}','{"translate":"pl.item.lore.money2b"}','{"translate":"pl.item.lore.money2c"}'],custom_data={id:"panling:money2"}] 2
