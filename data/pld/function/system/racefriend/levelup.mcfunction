execute if block 53 6 21 hopper{Items:[{components:{"minecraft:custom_data":{id:"panling:yh0"}}}]} run function pld:system/racefriend/level_ups/levelup0
execute if block 53 6 21 hopper{Items:[{components:{"minecraft:custom_data":{id:"panling:yh1"}}}]} run function pld:system/racefriend/level_ups/levelup1
