...
#根据玩家当前状态赋予近战傷害加成
#execute if score @s weapon_skill_sword6_lvl matches 1.. run attribute @s attack_damage modifier add panling:mod_11_5_5_5_1 0.15 add_multiplied_base
#execute if score @s weapon_skill_sword6_lvl matches 2.. run attribute @s attack_damage modifier add panling:mod_11_5_5_5_2 0.15 add_multiplied_base
#execute if score @s weapon_skill_sword6_lvl matches 3.. run attribute @s attack_damage modifier add panling:mod_11_5_5_5_3 0.15 add_multiplied_base
