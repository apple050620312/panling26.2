...
#根据玩家当前状态赋予近战傷害加成
#execute if score @s weapon_skill_sword6_lvl matches 1.. run attribute @s attack_damage modifier add 11-5-5-5-1 "如意金箍棒-齐天效果提供额外近战傷害1" 0.15 multiply_base
#execute if score @s weapon_skill_sword6_lvl matches 2.. run attribute @s attack_damage modifier add 11-5-5-5-2 "如意金箍棒-齐天效果提供额外近战傷害2" 0.15 multiply_base
#execute if score @s weapon_skill_sword6_lvl matches 3.. run attribute @s attack_damage modifier add 11-5-5-5-3 "如意金箍棒-齐天效果提供额外近战傷害3" 0.15 multiply_base
