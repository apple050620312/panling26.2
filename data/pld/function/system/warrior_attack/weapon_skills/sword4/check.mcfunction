...
execute unless entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{id:"panling:sword4",act:1}}}]}] run function pld:system/warrior_attack/weapon_skills/sword4/clear
