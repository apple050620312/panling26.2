...
execute unless entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{id:"panling:feather",lvl:4,brunch:4}}}]}] run attribute @s max_health modifier remove 8-8-8-8-8
execute unless entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{id:"panling:feather",lvl:4,brunch:5}}}]}] run attribute @s armor modifier remove 8-8-8-8-8
...
execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{id:"panling:feather",lvl:4,brunch:4}}}]}] run attribute @s max_health modifier add 8-8-8-8-8 "羽毛被动-生命" 2 add
execute if entity @s[nbt={Inventory:[{components:{"minecraft:custom_data":{id:"panling:feather",lvl:4,brunch:5}}}]}] run attribute @s armor modifier add 8-8-8-8-8 "羽毛被动-盔甲" 2 add
