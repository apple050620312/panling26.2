...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{components:{"minecraft:custom_data":{instance:4,chest:1}}}}]
loot spawn ~ ~ ~ loot pld:chests/goldchests/instance4
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{components:{"minecraft:custom_data":{instance:4,chest:1}}}}] run function pld:system/chests/goldchests/instance4/judge
