...
execute if score @s gold_chest matches 1.. if score @s inv_remain matches 1.. if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{id:"panling:goldkey"}}}}] run function pld:system/chests/goldchests/instance4/loot
