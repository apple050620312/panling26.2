...
kill @e[type=item,limit=1,sort=nearest,nbt={Item:{components:{"minecraft:custom_data":{instance:3,chest:1}}}}]
...
execute as @e[limit=1,type=item,sort=nearest,nbt={Item:{components:{"minecraft:custom_data":{instance:3,chest:1}}}}] run function pld:system/chests/goldchests/instance3/judge
