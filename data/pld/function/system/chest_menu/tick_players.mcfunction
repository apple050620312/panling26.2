...
execute if score @s screen matches 0.. run data modify storage pld:system Temp_ender_data set from storage pld:system Temp.EnderItems[{slot:0}].tag.data
#execute if score @s screen matches 0.. run tellraw yl_jiu_qiu {"nbt":"Temp.EnderItems[{slot:0}]","storage":"pld:system"}
