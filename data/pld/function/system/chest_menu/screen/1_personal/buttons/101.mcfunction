...
item replace entity @s enderchest.12 with minecraft:experience_bottle{clickable:1,to_screen:1,HideFlags:63,display:{Name:'{"translate":"pl.chest_menu.player_attribute"}'}}
