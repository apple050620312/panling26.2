...
item replace entity @s enderchest.12 with minecraft:experience_bottle[hide_additional_tooltip={},custom_name='{"translate":"pl.chest_menu.player_attribute"}',custom_data={clickable:1,to_screen:1}]
