#未解锁
item replace entity @s enderchest.3 with minecraft:chest{clickable:1,unlock_screen:202,HideFlags:63,display:{Name:'{"translate":"pl.chest_menu.unlock_screen202"}',Lore:['{"translate":"pl.chest_menu.unlock_screen202.lore.a"}','{"translate":"pl.chest_menu.unlock_screen202.lore.b"}']}}
