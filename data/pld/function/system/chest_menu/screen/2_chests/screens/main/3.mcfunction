#未解锁
item replace entity @s enderchest.4 with minecraft:chest{clickable:1,unlock_screen:203,HideFlags:63,display:{Name:'{"translate":"pl.chest_menu.unlock_screen203"}',Lore:['{"translate":"pl.chest_menu.unlock_screen203.lore.a"}','{"translate":"pl.chest_menu.unlock_screen203.lore.b"}']}}
