#未解鎖
item replace entity @s enderchest.5 with minecraft:chest{clickable:1,unlock_screen:204,HideFlags:63,display:{Name:'{"translate":"pl.chest_menu.unlock_screen204"}',Lore:['{"translate":"pl.chest_menu.unlock_screen204.lore.a"}','{"translate":"pl.chest_menu.unlock_screen204.lore.b"}']}}
