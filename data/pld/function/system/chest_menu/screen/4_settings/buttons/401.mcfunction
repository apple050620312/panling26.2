...
item replace entity @s enderchest.2 with iron_chestplate[hide_additional_tooltip={},custom_name='{"translate":"pl.chest_menu.switch_info.armor_skill.name"}',custom_data={clickable:1,to_screen:401}]
