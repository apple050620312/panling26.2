...
#物品&标题
execute if data storage pld:system Temp_the_mail{is_taked:0b} run item replace entity @s enderchest.14 with experience_bottle[custom_data={clickable:1,take_id:14}]
execute if data storage pld:system Temp_the_mail{is_taked:1b} run item replace entity @s enderchest.14 with paper[custom_data={clickable:1,take_id:14}]
