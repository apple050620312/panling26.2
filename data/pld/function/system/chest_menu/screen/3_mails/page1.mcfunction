...
#下翻页-占位符
execute if score player_mail_count int matches ..21 run item replace entity @s enderchest.17 with minecraft:black_stained_glass_pane[hide_additional_tooltip={},custom_name='{"translate":"pl.chest_menu.invalid_page_down"}',custom_data={clickable:1,reset_self_id:8}]
#下翻页
execute if score player_mail_count int matches 22.. run item replace entity @s enderchest.17 with minecraft:wooden_axe[custom_model_data=6,hide_additional_tooltip={},custom_name='{"translate":"pl.chest_menu.page_down"}',custom_data={clickable:1,to_page:2}]
