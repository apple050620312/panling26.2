...
scoreboard objectives add chests_enabled dummy ["末影箱菜单仓库解鎖数量"]
...
scoreboard objectives add all_protection_percent dummy ["全傷害减免-百分比"]
scoreboard objectives add arrow_protection_percent dummy ["弹射物傷害减免-百分比"]
scoreboard objectives add fire_protection_percent dummy ["火焰傷害减免-百分比"]
scoreboard objectives add magic_protection_percent dummy ["术法傷害减免-百分比"]
