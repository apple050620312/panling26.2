...
#execute if entity @s[nbt={Inventory:[{slot:103,components:{custom_data:{id:"panling:helmet22"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:103,components:{custom_data:{id:"panling:helmet32"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:103,components:{custom_data:{id:"panling:helmet42"}}}]}] run scoreboard players add @s zf_cool_reduce 5
#execute if entity @s[nbt={Inventory:[{slot:103,components:{custom_data:{id:"panling:helmet52"}}}]}] run scoreboard players add @s zf_cool_reduce 5
#
#execute if entity @s[nbt={Inventory:[{slot:102,components:{custom_data:{id:"panling:chestplate22"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:102,components:{custom_data:{id:"panling:chestplate32"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:102,components:{custom_data:{id:"panling:chestplate42"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:102,components:{custom_data:{id:"panling:chestplate52"}}}]}] run scoreboard players add @s zf_cool_reduce 5
#
#execute if entity @s[nbt={Inventory:[{slot:101,components:{custom_data:{id:"panling:leggings22"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:101,components:{custom_data:{id:"panling:leggings32"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:101,components:{custom_data:{id:"panling:leggings42"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:101,components:{custom_data:{id:"panling:leggings52"}}}]}] run scoreboard players add @s zf_cool_reduce 5
#
#execute if entity @s[nbt={Inventory:[{slot:100,components:{custom_data:{id:"panling:boots22"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:100,components:{custom_data:{id:"panling:boots32"}}}]}] run scoreboard players add @s zf_cool_reduce 0
#execute if entity @s[nbt={Inventory:[{slot:100,components:{custom_data:{id:"panling:boots42"}}}]}] run scoreboard players add @s zf_cool_reduce 5
#execute if entity @s[nbt={Inventory:[{slot:100,components:{custom_data:{id:"panling:boots52"}}}]}] run scoreboard players add @s zf_cool_reduce 5
#execute if entity @s[nbt={Inventory:[{slot:100,components:{custom_data:{id:"panling:boots4e1"}}}]}] run scoreboard players add @s zf_cool_reduce 10
#execute if entity @s[nbt={Inventory:[{slot:100,components:{custom_data:{id:"panling:boots5e1"}}}]}] run scoreboard players add @s zf_cool_reduce 15
#
