...
#给予烤肉
give @s[scores={zfsuccess=1}] minecraft:cooked_rabbit[minecraft:enchantments={protection:1},custom_name='{"translate":"pl.item.name.job1food1"}',lore=['{"translate":"pl.item.lore.job1food1a"}','{"translate":"pl.item.lore.food_buff_confliction"}','{"translate":"pl.item.lore.job1food1b"}','{"translate":"pl.item.lore.job1food1c"}','{"translate":"pl.item.lore.job1food1d"}','{"translate":"pl.item.lore.job1food1e"}'],custom_data={id:"panling:job1food1"}]
