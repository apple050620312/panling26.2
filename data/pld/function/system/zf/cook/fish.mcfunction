...
#给予烤鱼
give @s[scores={zfsuccess=1}] minecraft:cooked_cod[hide_additional_tooltip={},enchantments={levels:{"minecraft:protection":1}},custom_name='{"translate":"pl.item.name.job2food1"}',lore=['{"translate":"pl.item.lore.job2food1a"}','{"translate":"pl.item.lore.food_buff_confliction"}','{"translate":"pl.item.lore.job2food1b"}','{"translate":"pl.item.lore.job2food1c"}','{"translate":"pl.item.lore.job2food1d"}'],custom_data={id:"panling:job2food1"}]
