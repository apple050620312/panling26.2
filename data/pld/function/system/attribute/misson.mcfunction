...
attribute @s[scores={ex_te32=1}] minecraft:armor modifier add 0-0-1-0-4 "雨竹支线奖励-護甲" 2 add 
...
attribute @s[scores={ex_sunday=3}] minecraft:armor_toughness modifier add 0-0-1-0-3 "辛齐天支线奖励-韧性" 1 add
attribute @s[scores={ex_sword=1}] minecraft:max_health modifier add 0-0-1-0-2 "剑意支线奖励-生命" 2 add 

attribute @s[scores={race=0,finish_shen_hide=1}] minecraft:max_health modifier add 0-0-1-1-0 "神族隐藏奖励-生命" 2 add 
attribute @s[scores={race=1,finish_yao_hide=1}] minecraft:max_health modifier add 0-0-1-1-1 "妖族隐藏奖励-生命" 2 add 
attribute @s[scores={race=2,finish_xian_hide=1}] minecraft:max_health modifier add 0-0-1-1-2 "仙族隐藏奖励-生命" 2 add 
attribute @s[scores={race=3,finish_zhan_hide=1}] minecraft:max_health modifier add 0-0-1-1-3 "战神族隐藏奖励-生命" 2 add 
attribute @s[scores={race=4,finish_ren_hide=1}] minecraft:max_health modifier add 0-0-1-1-4 "人族隐藏奖励-生命" 2 add 
