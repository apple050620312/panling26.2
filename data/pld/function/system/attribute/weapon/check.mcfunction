...
execute store result score @s temp run data get entity @s Inventory[{tag:{act:1}}].tag.rare
execute store result score @s temp2 run data get entity @s Inventory[{tag:{act:1}}].tag.branch
