#提供效果
#给予玩家移动速度加成
attribute @p[tag=shooter] movement_speed modifier add panling:mod_11_5_5_5_1 0.04 add_multiplied_base
attribute @p[tag=shooter] movement_speed modifier add panling:mod_11_5_5_5_2 0.04 add_multiplied_base
attribute @p[tag=shooter] movement_speed modifier add panling:mod_11_5_5_5_3 0.04 add_multiplied_base
attribute @p[tag=shooter] movement_speed modifier add panling:mod_11_5_5_5_4 0.04 add_multiplied_base
attribute @p[tag=shooter] movement_speed modifier add panling:mod_11_5_5_5_5 0.04 add_multiplied_base
