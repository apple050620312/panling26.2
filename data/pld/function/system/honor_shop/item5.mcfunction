...
give @s[tag=buy_success] minecraft:player_head[custom_name='[{"translate":"pl.item.name.honor_head5"}]',lore=['{"translate":"pl.item.lore.honor_heads"}','{"translate":"pl.item.lore.honor_head5a"}','{"translate":"pl.item.lore.honor_head5b"}','{"translate":""}','{"translate":"pl.item.lore.honor_head_can_enchant"}'],custom_data={SkullOwner:{Id:[I;260497508,-338736586,-1333673891,-1422241753],Properties:{textures:[{Value: ""}]}},id:"panling:honor_head",type:5,enchanted:0}]
