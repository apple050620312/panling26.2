...
execute if score @s ld_count matches 1 if block 1351 39 494 hopper{Items:[{Slot:0b,components:{custom_data:{id:"panling:honor_head",enchanted:0}}}]} run function pld:system/honor_shop/enchant6/enchant6
