...
give @s[tag=buy_success] minecraft:zombie_head[custom_name='[{"translate":"pl.item.name.honor_head7"}]',lore=['{"translate":"pl.item.lore.honor_heads"}','{"translate":"pl.item.lore.honor_head7a"}','{"translate":"pl.item.lore.honor_head7b"}','{"translate":""}','{"translate":"pl.item.lore.honor_head_can_enchant"}'],custom_data={id:"panling:honor_head",type:7,enchanted:0}]
