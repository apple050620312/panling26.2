...
execute as @s[tag=buy_success] run setblock 1340 38 492 minecraft:oak_sign[block_entity_data={front_text:{messages:['{"translate":""}','{"translate":"pl.spsign.honor_exchange23_sold.text2"}']}}] replace
