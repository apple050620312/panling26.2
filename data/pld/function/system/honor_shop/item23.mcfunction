...
give @s[tag=buy_success] minecraft:black_dye{id:"panling:housekey_earth",display:{Name:'{"text":"§b城东坤府的钥匙"}',Lore:['{"translate":"pl.item.lore.housekeya"}','{"translate":"pl.item.lore.housekeyb"}']}} 5
