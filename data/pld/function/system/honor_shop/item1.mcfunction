...
give @s[tag=buy_success] minecraft:player_head[custom_name='[{"translate":"pl.item.name.honor_head1"}]',lore=['{"translate":"pl.item.lore.honor_heads"}','{"translate":"pl.item.lore.honor_head1a"}','{"translate":"pl.item.lore.honor_head1b"}','{"translate":""}','{"translate":"pl.item.lore.honor_head_can_enchant"}'],custom_data={SkullOwner:{Id:[I;260497508,-338736586,-1333673891,-1422241753],Properties:{textures:[{Value:""}]}},id:"panling:honor_head",type:1,enchanted:0}]
