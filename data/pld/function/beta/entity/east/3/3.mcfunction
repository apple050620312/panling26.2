...
#execute as fd9b8341-03d8-4859-b272-d33d1122e3d6 if data entity @s {Item:{tag:{display:{Name:'{"translate":"pl.frame.zhp"}'}}}} run function pld:beta/entity/east/3/next
