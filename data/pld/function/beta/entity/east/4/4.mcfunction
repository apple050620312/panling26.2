...
#execute as 0a320ab9-c097-4261-9bc0-fdd03f4fb7de if data entity @s {Item:{tag:{display:{Name:'{"translate":"pl.frame.ldp"}'}}}} run function pld:beta/entity/east/4/next
