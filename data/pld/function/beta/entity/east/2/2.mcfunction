...
#execute as 83c36ad3-fdc9-4e5f-9df4-a70472655d64 if data entity @s {Item:{tag:{display:{Name:'{"translate":"pl.frame.tjp"}'}}}} run function pld:beta/entity/east/2/next
