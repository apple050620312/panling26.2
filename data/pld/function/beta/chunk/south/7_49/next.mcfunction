...
setblock 122 44 805 minecraft:command_block[block_entity_data={Command:"function pld:npcs/south/texian"}] replace
setblock 122 28 814 minecraft:command_block[block_entity_data={Command:"function pld:npcs/south/sh4"}] replace
data merge block 121 47 811 {Items:[]}
setblock 121 47 809 minecraft:repeating_command_block[block_entity_data={Command:"function pld:system/truth/shen/4/check_in_room"}] replace 
...
setblock 124 32 819 minecraft:command_block[block_entity_data={Command:"execute as @p[x=124,y=32,z=817,distance=..5] run function pld:system/truth/shen/4/check_reward"}] replace 
