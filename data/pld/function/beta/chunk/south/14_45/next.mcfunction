...
setblock 245 12 720 minecraft:command_block[block_entity_data={Command:"function pld:npcs/south/southmain4"}] replace 
setblock 238 18 731 minecraft:command_block[block_entity_data={Command:"tp @p[distance=..6] 238 75 759"}] replace 
