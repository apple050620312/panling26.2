...
setblock 239 16 681 minecraft:command_block[custom_data={Command:"execute as @p[x=239,y=18,z=681,distance=..6] run function pld:system/altars/bird/intobird"}] replace 
#区块卸载
