...
setblock 10 43 813 minecraft:command_block[custom_data={Command:"function pld:npcs/south/southmain2"}] replace 
setblock -15 43 805 minecraft:command_block[custom_data={Command:"function pld:npcs/south/southmain1"}] replace 
setblock 11 43 810 minecraft:command_block[custom_data={Command:"function pld:npcs/south/tong4"}] replace 
