...
setblock 1326 56 456 minecraft:command_block[block_entity_data={Command:"execute as @p[x=1326,y=58,z=456,distance=..5] run function pld:selections/intopangu"}]
