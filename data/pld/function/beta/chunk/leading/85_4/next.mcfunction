...
setblock 1366 75 70 minecraft:command_block[block_entity_data={Command:"execute as @p[x=1366,y=77,z=70,distance=..2] run function pld:selections/race/select3"}] replace 
setblock 1362 74 70 minecraft:command_block[block_entity_data={Command:"function pld:npcs/select/leading_zhan"}] replace 
