...
#要做的事
setblock 1200 24 -334 structure_block[block_entity_data={metadata: "", mirror: "NONE", ignoreEntities: 0b, powered: 0b, seed: 0L, author: "?", rotation: "NONE", posX: 0, mode: "LOAD", posY: 1, posZ: 0, integrity: 1.0f, showair: 0b, name: "pld:training_part1", showboundingbox: 1b}]
...
setblock 1200 22 -362 structure_block[block_entity_data={metadata: "", mirror: "NONE", ignoreEntities: 0b, powered: 0b, seed: 0L, author: "?", rotation: "NONE", posX: 0, mode: "LOAD", posY: 1, posZ: 0, integrity: 1.0f, showair: 0b, name: "pld:training_part2", showboundingbox: 1b}]
setblock 1200 23 -362 redstone_block


setblock 1200 24 -384 structure_block[block_entity_data={metadata: "", mirror: "NONE", ignoreEntities: 0b, powered: 0b, seed: 0L, author: "?", rotation: "NONE", posX: 0, mode: "LOAD", posY: 1, posZ: 0, integrity: 1.0f, showair: 0b, name: "pld:training_part3", showboundingbox: 1b}]
