...
setblock 1324 61 40 minecraft:command_block[block_entity_data={Command:"execute as @p[x=1324,y=63,z=40,distance=..2] run function pld:selections/job/select_job0"}] replace 
setblock 1324 61 42 minecraft:command_block[block_entity_data={Command:"execute as @p[x=1324,y=63,z=42,distance=..2] run function pld:selections/job/select_job1"}] replace 
setblock 1324 61 44 minecraft:command_block[block_entity_data={Command:"execute as @p[x=1324,y=63,z=44,distance=..2] run function pld:selections/job/select_job2"}] replace 
