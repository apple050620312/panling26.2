...
setblock 1396 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/4_1"}] replace
setblock 1404 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/4_2"}] replace
setblock 1412 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/4_3"}] replace

setblock 1418 39 647 minecraft:command_block[custom_data={Command:"tp @p[x=1417,y=42,z=646,distance=..3] 1204 27 -381 -90 0"}] replace
