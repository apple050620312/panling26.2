...
setblock 1252 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/1_1"}] replace
setblock 1260 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/1_2"}] replace
setblock 1268 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/1_3"}] replace

setblock 1274 39 647 minecraft:command_block[custom_data={Command:"tp @p[x=1273,y=42,z=647,distance=..3] 1204 27 -381 -90 0"}] replace

setblock 1250 40 642 minecraft:command_block[custom_data={Command:"/particle happy_villager 1252 41 642 0.7 0.7 0.7 0 50"}] replace
