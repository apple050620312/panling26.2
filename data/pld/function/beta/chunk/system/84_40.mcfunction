...
setblock 1348 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/3_1"}] replace
setblock 1356 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/3_2"}] replace
setblock 1364 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/3_3"}] replace

setblock 1370 39 647 minecraft:command_block[custom_data={Command:"tp @p[x=1369,y=42,z=646,distance=..3] 1204 27 -381 -90 0"}] replace
