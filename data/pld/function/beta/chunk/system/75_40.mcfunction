...
setblock 1204 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/0_1"}] replace
setblock 1212 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/0_2"}] replace
setblock 1220 40 645 minecraft:command_block[custom_data={Command:"function pld:selections/stories/0_3"}] replace

setblock 1226 39 647 minecraft:command_block[custom_data={Command:"tp @p[x=1225,y=42,z=647,distance=..3] 1204 27 -381 -90 0"}] replace
