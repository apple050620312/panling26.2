...
setblock 307 29 -685 minecraft:command_block[custom_data={Command:"function pld:system/ld/ldmain"}] replace 
setblock 323 29 -685 minecraft:command_block[custom_data={Command:"function pld:system/ld/ldmain"}] replace 
data merge block 319 28 -685 {CustomName:'{"translate":"pl.name.ldl"}'}
data merge block 311 28 -685 {CustomName:'{"translate":"pl.name.ldl"}'}

setblock 315 25 -680 minecraft:command_block[custom_data={Command:"tp @p[x=315,y=28,z=-680,distance=..2] 353 53 -672"}] replace 
