...
setblock -696 105 -637 minecraft:command_block[custom_data={Command:"execute as @p[x=-697,y=108,z=-637,distance=..5] run function pld:instances/instance4/in"}] replace
