...
#要做的事
setblock -852 87 -203 minecraft:command_block[block_entity_data={Command:"function pld:npcs/west/xe4"}] replace 
...
setblock -851 91 -211 minecraft:command_block[block_entity_data={Command:"execute if entity @e[x=-858,y=90,z=-210,dx=14,dy=6,dz=14,type=cow] run function pld:system/ex_xian/cow_arrive"}] replace 
