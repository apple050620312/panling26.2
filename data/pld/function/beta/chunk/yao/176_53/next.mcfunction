#要做的事
setblock 2810 44 846 minecraft:command_block[block_entity_data={Command:"function pld:system/rechoose/rechoose"}] replace 
data merge block 2812 44 846 {Items:[]}
setblock 2822 40 844 minecraft:command_block[block_entity_data={Command:"function pld:npcs/yao/chat2"}] replace 

setblock 2802 49 851 minecraft:command_block[block_entity_data={Command:"function pld:npcs/yao/guard"}] replace 
setblock 2827 42 850 minecraft:command_block[block_entity_data={Command:"function pld:npcs/yao/guard"}] replace 
...
setblock 2814 44 856 minecraft:command_block[block_entity_data={Command:"execute as @p[x=2814,y=45,z=855,distance=..5] run function pld:system/menubook/update/main"}] destroy 
