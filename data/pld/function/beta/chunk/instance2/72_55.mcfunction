...
setblock 1158 55 894 minecraft:command_block[custom_data={Command:"execute as @p[distance=..10] positioned ~ ~3 ~ run function pld:system/chests/goldchests/instance2/check"}] replace 
setblock 1158 55 884 minecraft:command_block[custom_data={Command:"execute as @p[x=1158,y=57,z=884,distance=..3] run function pld:instances/instance2/reward"}] replace 
