...
#要做的事
setblock 2848 26 -192 minecraft:command_block[custom_data={Command:"execute as @p[x=2848,y=26,z=-190,distance=..3] run function pld:test/zhan/leave"}] replace 
setblock 2848 24 -178 minecraft:repeating_command_block[custom_data={Command:"execute as @p[x=2848,y=25,z=-180,distance=..3] run function pld:test/zhan/back"}] replace 
...
setblock 2861 24 -184 minecraft:command_block[custom_data={Command:"execute as @p[x=2862,y=25,z=-184,distance=..3] run function pld:test/zhan/finish"}] replace 
#区块卸载
