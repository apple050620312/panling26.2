...
setblock 2241 89 958 minecraft:command_block[custom_data={Command:"execute as @p[x=2241,y=91,z=958,distance=..10] run function pld:system/altars/turtle/intoturtletest"}] replace 
#区块卸载
