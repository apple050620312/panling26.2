...
setblock 3285 111 362 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/shenmain3"}] replace 
setblock 3283 111 359 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/shentong1"}] replace 
setblock 3291 111 360 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/shentong2"}] replace 
setblock 3291 111 359 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/shentong3"}] replace 

setblock 3293 111 376 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/guard"}] replace
...
setblock 3271 112 359 minecraft:command_block[custom_data={Command:"tp @p[distance=..3] 3276 99 356 180 0"}] replace 
