...
#要做的事
setblock 3232 96 281 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/guard"}] replace 
setblock 3231 95 272 minecraft:command_block[custom_data={Command:"function pld:npcs/shen/chat8"}] replace 
