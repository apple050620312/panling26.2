...
setblock 1730 119 175 minecraft:command_block[custom_data={Command:"function pld:npcs/ren/guard"}] replace 
setblock 1736 119 175 minecraft:command_block[custom_data={Command:"function pld:npcs/ren/guard"}] replace 
data merge block 1730 49 178 {front_text:{messages:['{"translate":""}','{"translate":"pl.sign.ren24.text2"}','{"translate":""}','{"translate":""}']}}

setblock 1731 49 180 minecraft:command_block[custom_data={Command:"tp @p[distance=..10] 1732 124 176"}] replace 
