...
setblock 1725 156 183 minecraft:command_block[block_entity_data={Command:"function pld:npcs/ren/guard"}] replace 
setblock 1722 158 171 minecraft:command_block[block_entity_data={Command:"function pld:npcs/ren/tong17"}] replace 
