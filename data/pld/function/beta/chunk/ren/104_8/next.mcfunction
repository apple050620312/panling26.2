...
setblock 1670 136 132 minecraft:command_block[custom_data={Command:"execute as @p[x=1671,y=137,z=132,distance=..5] run function pld:system/menubook/update/main"}] destroy
...
setblock 1666 136 141 minecraft:command_block[custom_data={Command:"function pld:system/rechoose/rechoose"}] replace

setblock 1667 143 127 minecraft:command_block[custom_data={Command:"function pld:npcs/ren/chat1"}] replace 
setblock 1664 142 131 minecraft:command_block[custom_data={Command:"function pld:npcs/ren/chat2"}] replace 
setblock 1677 131 138 minecraft:command_block[custom_data={Command:"function pld:npcs/ren/renmain1"}] replace 
setblock 1670 144 126 minecraft:command_block[custom_data={Command:"function pld:npcs/ren/guard"}] replace 
