...
setblock 1600 139 108 minecraft:command_block[block_entity_data={Command:"function pld:system/supply/supplymain"}] replace

setblock 1627 133 97 minecraft:command_block[block_entity_data={Command:"function pld:npcs/ren/tong5"}] replace
setblock 1628 133 97 minecraft:command_block[block_entity_data={Command:"function pld:npcs/ren/tong6"}] replace
setblock 1625 131 105 minecraft:command_block[block_entity_data={Command:"function pld:npcs/ren/chat12"}] replace
