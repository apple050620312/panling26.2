...
setblock -715 99 508 minecraft:command_block[custom_data={Command:"function pld:npcs/qiansi/tong2"}] replace
setblock -715 99 509 minecraft:command_block[custom_data={Command:"function pld:npcs/qiansi/tong3"}] replace 
setblock -713 99 522 minecraft:command_block[custom_data={Command:"function pld:npcs/qiansi/tong5"}] replace 
setblock -714 99 522 minecraft:command_block[custom_data={Command:"function pld:npcs/qiansi/tong6"}] replace 
