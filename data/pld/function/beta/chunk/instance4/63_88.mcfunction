...
setblock 1015 68 1413 minecraft:command_block[custom_data={Command:"execute as @p[distance=..10] positioned ~ ~3 ~ run function pld:system/chests/copperchests/instance1/check"}] replace
