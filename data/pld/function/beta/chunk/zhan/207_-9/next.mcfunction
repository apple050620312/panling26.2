...
setblock 3264 17 -248 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard2"}] replace 
#206 -16
setblock 3299 19 -254 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhanmain3"}] replace 
data merge block 3306 23 -253 {CustomName:'{"translate":"pl.name.dzt"}'}
#205 -16
setblock 3287 19 -241 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhantong1"}] replace 
#205 -17
setblock 3286 20 -267 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhantong2"}] replace 
setblock 3287 20 -267 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhantong3"}] replace 

setblock 3301 19 -260 structure_block[block_entity_data={metadata: "",mirror: "NONE",ignoreEntities: 0b,powered: 0b,seed: 0L,author: "?",rotation: "NONE",posX: 0,mode: "LOAD",posY: 1,posZ: 0,integrity: 1.0f,showair: 0b,name: "pld:tjp3",showboundingbox: 1b}]
