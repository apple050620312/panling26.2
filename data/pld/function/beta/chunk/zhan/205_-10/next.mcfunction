...
setblock 3284 16 -135 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhanmain1"}] replace 
setblock 3265 16 -148 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhanmain2"}] replace 
setblock 3266 15 -151 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/chat1"}] replace 
setblock 3271 15 -151 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/chat2"}] replace 
setblock 3273 15 -153 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/supply3"}] replace 
setblock 3268 17 -139 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/pvp1_atk"}] replace

setblock 3287 16 -143 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard1"}] replace 
setblock 3287 16 -135 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard1"}] replace 
setblock 3281 16 -134 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard2"}] replace 
setblock 3281 16 -142 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard2"}] replace 
setblock 3264 27 -159 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard2"}] replace 
setblock 3274 16 -148 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard2"}] replace 
...
setblock 3274 19 -155 minecraft:command_block[block_entity_data={Command:"function pld:system/supply/supplymain"}] replace 
...
setblock 3278 19 -136 minecraft:command_block[block_entity_data={Command:"execute as @p[x=3279,y=20,z=-136,distance=..5] run function pld:system/menubook/update/main"}] destroy 
...
setblock 3262 11 -138 minecraft:command_block[block_entity_data={Command:"execute as @p[x=3264,y=11,z=-138,distance=..5] run function pld:pvp/1/pre/sign/sign_up_atk"}] replace
setblock 3267 21 -135 minecraft:command_block[block_entity_data={Command:"execute as @p[x=3267,y=21,z=-137,distance=..5] run function pld:pvp/1/pre/sign/player_check_atk"}] replace
setblock 3272 11 -138 minecraft:command_block[block_entity_data={Command:"tp @p[distance=..5] 3266 21 -138 -90 0"}] replace
