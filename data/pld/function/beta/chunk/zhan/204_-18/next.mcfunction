...
setblock 3274 15 -262 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/guard2"}] replace 

setblock 3259 18 -276 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhantong5"}] replace 
setblock 3272 18 -278 minecraft:command_block[block_entity_data={Command:"function pld:npcs/zhan/zhantong6"}] replace 
