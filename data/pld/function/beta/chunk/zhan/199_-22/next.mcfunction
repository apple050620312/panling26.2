...
setblock 3204 17 -346 minecraft:command_block[custom_data={Command:"execute as @p[x=3200,y=19,z=-346,distance=..10] run function pld:system/race_tp/race3_out"}] destroy
setblock 3191 15 -340 minecraft:command_block[custom_data={Command:"function pld:npcs/zhan/guard2"}] replace 
setblock 3210 15 -340 minecraft:command_block[custom_data={Command:"function pld:npcs/zhan/guard2"}] replace 
