...
#要做的事
setblock 80 41 141 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/te23"}] replace 
setblock 89 44 142 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong2"}] replace 
setblock 89 42 142 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong3"}] replace 
setblock 86 42 149 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong8"}] replace 
setblock 83 44 149 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong9"}] replace 
setblock 83 42 149 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong10"}] replace
setblock 89 41 133 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat16"}] replace 
setblock 71 45 142 minecraft:command_block[block_entity_data={Command:"tp @p[x=76,y=47,z=142,distance=..3] 80 33 156 -90 0"}] replace 
setblock 73 44 142 minecraft:repeating_command_block[block_entity_data={Command:"tp @e[x=76,y=47,z=142,distance=..3,type=!player] ~ ~-1000 ~"}] replace 
...
setblock 75 40 144 structure_block[block_entity_data={metadata: "", mirror: "NONE", ignoreEntities: 0b, powered: 0b, seed: 0L, author: "?", rotation: "NONE", posX: 0, mode: "LOAD", posY: 1, sizeX: 7, posZ: 0,integrity:1.0f,showair:0b,name:"pld:en_npcs",sizeY:9,sizeZ:4,showboundingbox:0b}]
