#要做的事
setblock 273 41 -188 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/zhanmain5"}] replace 
setblock 277 19 -183 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/ze2"}] replace 
setblock 272 45 -185 minecraft:repeating_command_block[custom_data={Command:"function pld:system/ex_zhan/check"}] replace 

setblock 276 22 -178 minecraft:command_block[custom_data={Command:"execute as @p[x=276,y=24,z=-178,distance=..1] run function pld:system/ex_zhan/leave_ze2"}] replace 
