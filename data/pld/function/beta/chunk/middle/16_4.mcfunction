...
setblock 288 42 68 minecraft:command_block[custom_data={Command:"function pld:system/house/sky"}] replace 
setblock 288 42 70 minecraft:command_block[custom_data={Command:"function pld:system/house/sky"}] replace 

setblock 261 44 69 minecraft:command_block[custom_data={Command:"function pld:system/house/earth"}] replace 
setblock 261 44 71 minecraft:command_block[custom_data={Command:"function pld:system/house/earth"}] replace 
