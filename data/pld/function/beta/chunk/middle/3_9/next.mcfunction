...
setblock 48 41 155 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat23"}] replace 
setblock 64 40 154 minecraft:command_block[block_entity_data={Command:'tellraw @a[distance=..6] {"translate":"pl.info.armor_stand4"}'}] replace 
