...
setblock 173 44 160 minecraft:command_block[custom_data={Command:"execute as @p[x=173,y=47,z=160,distance=..10] run function pld:system/te71/incheck"}] replace 
setblock 173 46 162 minecraft:repeating_command_block[custom_data={Command:"execute as @p[x=175,y=48,z=162,distance=..10] run function pld:system/te71/bee_found"}] replace 
data merge block 175 46 162 {Items:[]}
setblock 161 11 166 minecraft:command_block[custom_data={Command:"execute as @p[x=161,y=12,z=164,distance=..10] run function pld:system/te71/honey_check"}] replace 

data merge block 161 11 164 {Items:[]}
fill 161 11 167 161 11 168 air


setblock 162 7 164 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/chat69"}] replace 
setblock 162 42 162 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/chat71"}] replace 
