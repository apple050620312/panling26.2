...
setblock 124 58 -148 minecraft:command_block[custom_data={Command:"execute as @p[x=124,y=59,z=-147,distance=..5] run function pld:pvp/1/pre/sign/sign_up_def"}] replace
setblock 120 54 -146 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/pvp1_def"}] replace
