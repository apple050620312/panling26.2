#要做的事
setblock 33 44 52 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat56"}] replace
setblock 42 44 51 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong21b"}] replace
setblock 45 44 47 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat60"}] replace
setblock 38 43 56 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat61"}] replace
