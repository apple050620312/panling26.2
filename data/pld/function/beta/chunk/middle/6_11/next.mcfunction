...
setblock 162 41 186 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/food1"}] replace 
setblock 146 41 184 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/food2"}] replace 
setblock 135 42 185 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/food3"}] replace 
setblock 119 42 185 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/food4"}] replace 
setblock 101 42 184 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong11"}] replace 
setblock 187 42 178 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat04"}] replace 
setblock 167 41 179 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat05"}] replace 
setblock 151 41 176 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat06"}] replace 
setblock 155 41 184 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat07"}] replace 
setblock 130 41 188 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat08"}] replace 
setblock 127 41 185 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/chat09"}] replace 
