...
setblock 34 42 163 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/rentong7"}] replace 
setblock 31 45 161 minecraft:command_block[custom_data={Command:"particle enchant ~ ~3 ~ 0.2 0.2 0.2 0.0 4"}] replace 
setblock 37 45 162 minecraft:repeating_command_block[custom_data={Command:"/data merge block ~ ~ ~2 {Items:[]}"}] replace
