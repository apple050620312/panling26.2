...
setblock 173 63 -159 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/renmain5"}] replace 
setblock 178 63 -164 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/shenmain5"}] replace 
setblock 186 61 -158 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/xianmain5"}] replace 
