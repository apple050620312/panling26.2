...
setblock 257 46 32 minecraft:command_block[block_entity_data={Command:"function pld:npcs/middle/tong12"}] replace 
setblock 265 25 32 structure_block[block_entity_data={metadata: "", mirror: "NONE", ignoreEntities: 1b, powered: 0b, seed: 0L, author: "yl_jiu_qiu", rotation: "NONE", posX: 0, mode: "LOAD", posY: 1, sizeX: 23, posZ: 0, integrity: 1.0f, showair: 0b,  name: "pld:ldf", sizeY: 11, sizeZ: 22, showboundingbox: 1b}]
