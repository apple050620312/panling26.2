...
setblock 87 43 110 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/tong14"}] replace 
setblock 87 44 109 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/tong15"}] replace 
setblock 87 45 110 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/tong16"}] replace 
setblock 77 42 102 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/tong17"}] replace 
