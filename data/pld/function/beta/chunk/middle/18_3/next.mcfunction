...
setblock 324 39 67 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/tong13a"}] replace 
setblock 303 39 59 minecraft:command_block[custom_data={Command:"function pld:npcs/middle/chat55"}] replace 
