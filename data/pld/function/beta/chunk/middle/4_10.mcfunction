...
#要做的事
setblock 69 42 172 minecraft:command_block[custom_data={Command:'tellraw @a[distance=..6] {"translate":"pl.info.armor_stand2"}'}] replace 
setblock 83 42 171 minecraft:command_block[custom_data={Command:'tellraw @a[x=84,y=45,z=170,distance=..5] {"translate":"pl.info.armor_stand5a"}'}] replace 
setblock 82 44 170 minecraft:repeating_command_block[custom_data={Command:"execute as @p[x=84,y=45,z=170,distance=..10] run function pld:npcs/middle/armstand3"}] replace 
setblock 69 42 164 minecraft:command_block[custom_data={Command:"execute as @p[x=72,y=46,z=159,distance=..1] at @s run function pld:npcs/middle/armstand5"}] replace 
