...
setblock 2840 27 -414 minecraft:command_block[block_entity_data={Command:"function pld:instances/instance1/check"}] replace 
fill 2857 26 -411 2857 26 -410 command_block[block_entity_data={Command:"tp @p[distance=..3] 2854 29 -410"}] replace 
