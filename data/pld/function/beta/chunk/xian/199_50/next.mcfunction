...
setblock 3181 105 835 minecraft:command_block[custom_data={Command:"particle enchant ~ ~3 ~ 0.2 0.2 0.2 0.0 4"}] replace 
setblock 3181 102 833 minecraft:command_block[custom_data={Command:"function pld:npcs/xian/xiantong7"}] replace 
setblock 3172 89 808 minecraft:command_block[custom_data={Command:"function pld:npcs/xian/chat4"}] replace 
setblock 3171 89 804 minecraft:command_block[custom_data={Command:"function pld:npcs/xian/chat5"}] replace 
