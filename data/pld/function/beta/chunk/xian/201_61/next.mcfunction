...
setblock 3229 45 979 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/chat9"}] replace 
setblock 3246 42 1005 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/chat10"}] replace 
