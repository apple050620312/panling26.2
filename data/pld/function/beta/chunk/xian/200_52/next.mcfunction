...
setblock 3206 83 864 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/xianmain4"}] replace 
setblock 3205 83 864 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/xiantong4"}] replace
