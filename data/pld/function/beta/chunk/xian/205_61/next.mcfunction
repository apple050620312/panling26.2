...
setblock 3286 87 988 minecraft:command_block[block_entity_data={Command:"function pld:system/supply/supplymain"}] replace 
setblock 3285 84 980 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/guard"}] replace 
setblock 3281 84 984 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/guard"}] replace 
setblock 3281 84 989 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/guard"}] replace 
setblock 3271 80 986 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/chat8"}] replace 
setblock 3285 83 985 minecraft:command_block[block_entity_data={Command:"function pld:npcs/xian/supply2"}] replace 
