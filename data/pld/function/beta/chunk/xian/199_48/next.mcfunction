...
setblock 3187 100 789 minecraft:command_block[custom_data={Command:"execute as @p[x=3188,y=101,z=789,distance=..5] run function pld:system/menubook/update/main"}] destroy 

setblock 3190 101 783 air
fill 3191 100 782 3191 99 782 minecraft:stone
setblock 3190 100 782 minecraft:command_block[custom_data={Command:"function pld:npcs/xian/xianmain1"}] replace 
setblock 3187 103 776 minecraft:command_block[custom_data={Command:"function pld:system/rechoose/rechoose"}] replace 
