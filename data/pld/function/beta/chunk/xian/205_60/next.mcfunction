...
setblock 3287 72 960 minecraft:command_block[custom_data={Command:"function pld:npcs/xian/guard"}] replace 
setblock 3264 78 974 minecraft:command_block[custom_data={Command:"function pld:npcs/xian/guard"}] replace 
