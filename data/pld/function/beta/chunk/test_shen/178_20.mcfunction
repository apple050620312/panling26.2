...
#要做的事
setblock 2851 26 327 minecraft:command_block[custom_data={Command:"execute as @p[x=2851,y=26,z=329,distance=..3] run function pld:test/shen/leave"}] replace 
setblock 2851 24 341 minecraft:repeating_command_block[custom_data={Command:"execute as @p[x=2851,y=25,z=339,distance=..3] run function pld:test/shen/back"}] replace 
