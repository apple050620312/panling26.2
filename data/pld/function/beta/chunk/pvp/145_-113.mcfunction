...
#要做的事
setblock 2333 182 -1801 minecraft:command_block[block_entity_data={Command:"execute as @p[x=2333,y=184,z=-1801,distance=..2] run function pld:pvp/3/end/atk/reward"}] replace 
setblock 2393 182 -1801 minecraft:command_block[block_entity_data={Command:"execute as @p[x=2393,y=184,z=-1801,distance=..2] run function pld:pvp/3/end/def/reward"}] replace 
...
setblock 2333 178 -1801 minecraft:command_block[block_entity_data={Command:"execute as @p[x=2334,y=179,z=-1801,distance=..3] run function pld:pvp/3/ing/atk/check"}] replace 
setblock 2381 178 -1801 minecraft:command_block[block_entity_data={Command:"execute as @p[x=2382,y=179,z=-1801,distance=..3] run function pld:pvp/3/ing/def/check"}] replace 
