...
setblock 526 31 18 minecraft:command_block[block_entity_data={Command:"particle enchant ~ ~3 ~ 0.2 0.2 0.2 0.0 4"}] replace 
setblock 527 29 17 minecraft:command_block[block_entity_data={Command:"function pld:npcs/east/rentong7"}] replace 
