...
setblock 598 39 37 minecraft:command_block[block_entity_data={Command:"function pld:npcs/east/renmain6"}] replace 
setblock 591 27 47 minecraft:command_block[block_entity_data={Command:"function pld:npcs/east/zhanmain6"}] replace 
data merge block 575 34 36 {front_text:{messages:['{"text":""}','{"translate":"pl.sign.east4.text2"}','{"text":""}','{"text":""}']}}


setblock 581 27 47 minecraft:command_block[block_entity_data={Command:'tellraw @p[x=581,y=33,z=51,distance=..5,scores={race=3,dragon=0}] {"translate":"pl.info.zm6"}'}] replace 
