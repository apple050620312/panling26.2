...
setblock 562 32 394 minecraft:command_block[block_entity_data={Command:"execute as @p[x=562,y=34,z=394,distance=..3] run function pld:system/altars/dragon/intodargon"}] replace 
#区块卸载
