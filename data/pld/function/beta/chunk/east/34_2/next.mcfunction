...
setblock 551 32 39 minecraft:command_block[custom_data={Command:"function pld:npcs/east/te19"}] replace
setblock 557 31 37 minecraft:command_block[custom_data={Command:"function pld:npcs/east/fishbuy"}] replace
