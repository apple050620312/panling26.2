...
execute if block 1662 24 -225 hopper{Items:[{components:{"minecraft:custom_data":{id:"panling:relive_stone"}}}]} run give @s minecraft:potion{CustomName:'{"},custom_data={id:"panling:killpotion",CustomPotionColor:4393481,CustomPotionEffects:[{Id:7b,Amplifier:19b,Duration:20}]}]
