...
execute if block 1662 24 -225 hopper{Items:[{components:{"minecraft:custom_data":{id:"panling:relive_stone"}}}]} run clear @s minecraft:potion[custom_data={id:"panling:killpotion"}]
